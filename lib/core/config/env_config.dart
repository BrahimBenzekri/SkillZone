...
class EnvConfig {
  ...
  static String get refreshToken => '$apiBaseUrl/api/v1/token/refresh/';
  ...
  static String getLessonsForCourse(String courseId) =>
      '$apiBaseUrl/api/v1/courses/$courseId/lessons/';
  static String unlockCourse(String courseid) =>
      '$apiBaseUrl/api/v1/courses/$courseid/unlock/';
  static String getQuiz(String courseID) =>
      '$apiBaseUrl/api/v1/quizzes/courses/$courseID/quiz_data/';
