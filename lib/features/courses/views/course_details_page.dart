                    ...
                    children: [
                      ...
                      FadeInUp(
                        ...
                        child: Row(
                          ...
                          children: [
                            _buildStat(
                                Icons.star, '${course.rating}', 'Rating'),
                            _buildStat(
                                Icons.timer, course.durationText, 'Duration'),
                            _buildStat(Icons.library_books,
                                ...
                                if (course.type == CourseType.hard) ...[
                                  ...
                                  ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: inventoryController
                                              .enrolledCourseIds
                                              .contains(course.id)
                                    ...
                                    onPressed: () async {
                                      if (inventoryController.enrolledCourseIds
                                          .contains(course.id)) {
                                        Get.snackbar(
                                          'Already Enrolled',
                                        ...
                                        await Get.find<InventoryController>()
                                            .enrollInCourse(course.id);
                                      }
                                    },
                                    child: Text(
                                      inventoryController.enrolledCourseIds
                                              .contains(course.id)
                                          ? 'Enrolled'
                                          : 'Enroll Now',
                                      style: TextStyle(
                      ...
                      ...course.lessons.asMap().entries.map((entry) {
                        ...
                        return FadeInUp(
                          duration: Duration(milliseconds: 1250 + index * 150),
                          child: LessonCard(
                            lesson: lesson,
                            onTap: isEnrolled
                                ? () =>
                      ...
                      if (isEnrolled) ...[
                        ...
                        FadeInUp(
                          ...
                          child: Obx(() {
                            final progress = Get.find<InventoryController>()
                                .getCourseProgress(course.id);
